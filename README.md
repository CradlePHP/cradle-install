...
Package manager admin interface used to install and manage third party libraries.
...
```
$ composer require cradlephp/composer
```
...
4. All pull requests will be passed to [Travis CI](https://travis-ci.org/CradlePHP/cradle-install) to be tested. Also note that [Coveralls](https://coveralls.io/github/CradlePHP/cradle-install) is also used to analyze the coverage of your contribution.
